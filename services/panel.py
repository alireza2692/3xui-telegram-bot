...
class PanelClient:
    ...
    async def add_client(self, email: str, sub_id: str, traffic_bytes: int, expire_ms: int,
                         inbound_id=None, flow=None) -> None:
    ...
    async def create_client(self, gb: float, days: int, email: str = "",
                            inbound_id: int = None, flow: str = None) -> tuple:
        ...
        await self.add_client(email, sub_id, traffic_bytes, expire_ms, inbound_id=inbound_id, flow=flow)
        return email, sub_id
